...
const Auth = ({ children }: IAuth) => {
  ...
  return (
    <div
      className={`${auth !== null ? "-translate-x-[0%]" : "translate-x-[100%]"} fixed right-0 z-50 flex h-3/4 w-4/12 transform items-center justify-end rounded-l-full bg-white/20 py-5 pl-5 transition-transform duration-500  ease-in-out`}
    >
